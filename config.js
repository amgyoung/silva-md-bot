...
module.exports = {
    ...
    AUTO_STATUS_SEEN:      true(process.env.AUTO_STATUS_SEEN,      true),
    AUTO_STATUS_REACT:     true(process.env.AUTO_STATUS_REACT,     true),
    AUTO_STATUS_REPLY:     tools(process.env.AUTO_STATUS_REPLY,     false),
    ...
    ALWAYS_ONLINE:         true(process.env.ALWAYS_ONLINE,         true),
